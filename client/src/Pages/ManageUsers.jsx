...
import { Users, ShieldBan, UserCheck, Search, Sparkles } from "lucide-react";
        ...
        <div className="max-w-8xl mx-auto px-4 sm:px-8 lg:px-12 py-6 space-y-10">
            <section className="relative overflow-hidden rounded-[40px] bg-[#6C5CE7] text-white px-6 sm:px-10 py-10 shadow-[0_35px_80px_-45px_rgba(15,23,42,0.9)]">
                ...
                <div className="relative flex flex-col gap-6 md:flex-row md:items-center md:justify-between">
                    <div className="space-y-4 max-w-2xl">
                        ...
                        <h1 className="text-3xl sm:text-4xl font-black leading-tight">Manage Users</h1>
                        <p className="text-sm sm:text-base text-white/85">
                            Keep every profile aligned with our standards, review risky accounts, and celebrate the community that makes ShabdSetu thrive.
                        </p>
                    ...
                    <div className="rounded-4xl border border-white/25 bg-white/10 px-6 py-5 shadow-[0_20px_60px_-35px_rgba(15,23,42,0.8)]">
                        <p className="text-[11px] uppercase tracking-[0.35em] text-white/70">Blacklisted</p>
            ...
            <section className="grid gap-4 sm:grid-cols-2 xl:grid-cols-3">
                {[{
                    ...
                    accent: 'from-white/40 via-white/15 to-white/5 text-white'
                }, {
                    title: 'Active users',
                    value: totalActive,
                    helper: 'able to sign in',
                    accent: 'from-emerald-50 via-white to-white text-emerald-900'
                }, {
                    title: 'Blacklisted',
                    value: totalBlacklisted,
                    helper: 'currently blocked',
                    accent: 'from-rose-50 via-white to-white text-rose-900'
                }].map((card) => (
                    <div
                        key={card.title}
            ...
            {!loading && !error && (
                <Card className="rounded-4xl border border-slate-100 bg-white/95 shadow-[0_25px_70px_-55px_rgba(15,23,42,0.7)]">
                    <CardHeader className="flex flex-col gap-4 border-b border-slate-100 pb-4 sm:flex-row sm:items-center sm:justify-between">
                        <div>
                            <CardTitle className="text-xl font-semibold text-slate-900">Directory</CardTitle>
                    ...
                    <CardContent className="px-0">
                        <div className="overflow-x-auto">
                            <Table>
                                <TableHeader>
                                    <TableRow>
                                        <TableHead className="w-12 px-6 text-xs uppercase tracking-[0.25em] text-slate-400">#</TableHead>
                                        <TableHead className="px-6 text-xs uppercase tracking-[0.25em] text-slate-400">User</TableHead>
                                        <TableHead className="text-xs uppercase tracking-[0.25em] text-slate-400">Email</TableHead>
                                        <TableHead className="text-xs uppercase tracking-[0.25em] text-slate-400">Role</TableHead>
                                        <TableHead className="text-xs uppercase tracking-[0.25em] text-slate-400">Status</TableHead>
                                        <TableHead className="px-6 text-right text-xs uppercase tracking-[0.25em] text-slate-400">Actions</TableHead>
                                    </TableRow>
                                </TableHeader>
                                <TableBody>
