    ...
    const SavedSkeletonCard = () => (
        <div className="flex flex-col gap-4 rounded-3xl border border-gray-100 bg-white/90 p-5 shadow-[0_12px_40px_-20px_rgba(15,23,42,0.35)] animate-pulse">
            ...
            <div className="space-y-3 pt-2">
                ...
                <div className="flex items-center justify-between rounded-2xl border border-gray-100 bg-white/80 px-4 py-3">
    ...
    return (
        <div className="space-y-10 px-4 pt-6 pb-16 text-gray-900 sm:px-8 lg:px-12">
            <section className="relative mt-4 overflow-hidden rounded-[40px] bg-[#6C5CE7] px-8 py-10 text-white shadow-[0_35px_80px_-45px_rgba(15,23,42,0.85)] lg:px-12">
                ...
                <div className="absolute -bottom-24 -left-10 h-72 w-72 rounded-full bg-purple-300/25 blur-3xl" />
                <div className="relative flex flex-col gap-10 lg:flex-row lg:items-center">
                    ...
                    <div className="grid gap-4 sm:grid-cols-1 lg:w-auto">
                        {[{
                            label: "Saved posts",
            ...
            <section className="space-y-4 rounded-3xl border border-gray-100 bg-white/80 px-6 py-6 shadow-[0_20px_60px_-40px_rgba(15,23,42,0.5)] backdrop-blur-sm">
                <div className="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
                    ...
                    <div className="flex items-center gap-3">
                        <div className="rounded-2xl border border-gray-200 bg-white px-3 py-2 text-xs font-semibold uppercase tracking-[0.35em] text-gray-500">
            ...
            {loading ? (
                <section className="space-y-6">
                    <div className="flex items-center justify-between rounded-3xl border border-gray-100 bg-white/70 px-6 py-4 text-sm text-gray-500 shadow-sm backdrop-blur animate-pulse">
                ...
                <section className="space-y-6">
                    <div className="flex items-center justify-between rounded-3xl border border-gray-100 bg-white/70 px-6 py-4 text-sm text-gray-500 shadow-sm backdrop-blur">
